...
//  // the following equation was taken from the documentation [MPU-6000/MPU-6050 Register Map and Description, p.30]
  ...
  Serial.print(" | gX = "); Serial.print(String(gyro_x/bitVal));
  Serial.print(" | gY = "); Serial.print(String(gyro_y/bitVal));
  Serial.print(" | gZ = "); Serial.print(String(gyro_z/bitVal));
  Serial.println();
